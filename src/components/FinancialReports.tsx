...
import { BarChart3, PieChart as PieIcon, TrendingUp, DollarSign, Calendar, Filter } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-6 pb-12">
      ...
      <div className="bg-white/40 backdrop-blur-md p-6 rounded-3xl border border-white/60 shadow-[8px_8px_16px_#d1d9e6,-8px_-8px_16px_#ffffff] flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-2 bg-white/60 p-1.5 rounded-2xl border border-white/80 shadow-inner">
          {[
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-white/40 backdrop-blur-md p-6 rounded-3xl border border-white/60 shadow-[8px_8px_16px_#d1d9e6,-8px_-8px_16px_#ffffff] flex flex-col justify-between">
        ...
        <div className="lg:col-span-4 bg-white/40 backdrop-blur-md p-6 rounded-3xl border border-white/60 shadow-[8px_8px_16px_#d1d9e6,-8px_-8px_16px_#ffffff] flex flex-col justify-between">
